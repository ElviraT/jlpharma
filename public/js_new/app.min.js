        ...
        a =
            ...
            )),
            {
                ...
                ManageThemeBackground: function () {
                    ...
                    null != (a = t.LogoBg) && "" != a
                        ? $(
                              "#" + i + " .topbar .top-navbar .navbar-header"
                          ).attr("data-logobg", a)
                        : $(
                              "#" + i + " .topbar .top-navbar .navbar-header"
                          ).attr("data-logobg", "skin1"),
                        null != (e = t.NavbarBg) && "" != e
                        ...
                        case "full":
                            ...
                            $(window).ready(a),
                                ...
                                $(".sidebartoggler").on("click", function () {
                                    $("#main-wrapper").toggleClass(
                                        "mini-sidebar"
                                    ),
                                        $("#main-wrapper").hasClass(
                                            "mini-sidebar"
                                        )
                                            ? ($(".sidebartoggler").prop(
                                                  "checked",
        ...
        $("#chat .message-center a").on("click", function () {
            ...
            $(document).on(
                ...
                function (a) {
                    ...
                    $(".chat-windows #user-chat" + e).hide(),
                        $(
                            "#chat .message-center .user-info#chat_user_" + e
                        ).removeClass("active");
                }
            ),
            $(document).on(
                ...
                function (a) {
                    ...
                    $(".chat-windows #user-chat" + e).hasClass("mini-chat")
                        ? $(".chat-windows #user-chat" + e).removeClass(
                              "mini-chat"
                          )
                        : $(".chat-windows #user-chat" + e).addClass(
                              "mini-chat"
                          );
                }
            ),
            $(document).on(
                ...
                function (a) {
                    ...
                    $(
                        ".chat-windows #user-chat" + e + " .chat-body"
