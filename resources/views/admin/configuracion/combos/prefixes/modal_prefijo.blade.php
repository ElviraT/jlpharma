<div id="modal_prefix" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog"
    aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header modal-header-success">
                <h5 class="modal-title" id="exampleModalLongTitle">Agregar Prefijo</h5>
            ...
            <form action="#" id="form-enviar" method="post">
                ...
                <div class="modal-body">
                    {{ Form::hidden('id', 0, ['class' => 'modal_registro_prefix_id']) }}
                    @csrf
