<div id="modal_parroquia" class="modal fade bd-example-modal-sm" role="dialog" aria-labelledby="mySmallModalLabel"
    aria-hidden="true">
            ...
            <form action="#" id="form-enviar" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select id="municipality" name="idMunicipality" class="pickerSelectClass form-control"
                            style="width: 100%">
                            <option></option>
