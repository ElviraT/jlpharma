<div id="modal_mark" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="#" id="form-enviar" method="post">
                ...
                <div class="modal-body">
                    {{ Form::hidden('id', 0, ['class' => 'modal_registro_mark_id']) }}
                    @csrf
